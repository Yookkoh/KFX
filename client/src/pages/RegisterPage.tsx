      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-primary items-center justify-center p-12">
        <div className="max-w-md text-white">
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-3xl font-bold">KinkyForex</span>
          </div>
          <h1 className="text-4xl font-bold mb-4">
            Start Tracking Your Profits Today
          </h1>
          <p className="text-lg text-white/80">
            Join KinkyForex and take control of your USDT trading business. Track every transaction, monitor card usage, and maximize your profits.
          </p>
          <ul className="mt-8 space-y-4">
            ...
            <li className="flex items-center gap-3">
              <div className="w-6 h-6 bg-white/20 rounded-full flex items-center justify-center text-sm">✓</div>
              <span>Partnership profit splitting</span>
            </li>
            <li className="flex items-center gap-3">
              <div className="w-6 h-6 bg-white/20 rounded-full flex items-center justify-center text-sm">✓</div>
              <span>CSV export & reporting</span>
            </li>
          </ul>
        </div>
      </div>
        ...
        <Card className="w-full max-w-md border-0 shadow-none lg:shadow-lg lg:border">
          <CardHeader className="space-y-1 text-center">
            <div className="lg:hidden flex items-center justify-center gap-2 mb-4">
              ...
              <span className="text-2xl font-bold text-gradient">KinkyForex</span>
            </div>
